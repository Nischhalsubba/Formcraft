...
<p>
  ...
  <a href="https://github.com/Nischhalsubba/Formcraft/codespaces/new?ref=fix%2Ffirst-owner-autofill"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `fix/first-owner-autofill`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/Formcraft/blob/fix/first-owner-autofill/README.md)
- [`assets/js/auth-onboarding.js`](https://github.com/Nischhalsubba/Formcraft/blob/fix/first-owner-autofill/assets/js/auth-onboarding.js)
- [`index.html`](https://github.com/Nischhalsubba/Formcraft/blob/fix/first-owner-autofill/index.html)
...
```mermaid
flowchart TD
    ROOT["Formcraft / fix/first-owner-autofill"]
    ROOT --> P0[".github/"]
    ROOT --> P1["assets/"]
    ROOT --> P2["docs/"]
    ROOT --> P3["scripts/"]
...
|---|---|
| Data | [`supabase`](https://github.com/Nischhalsubba/Formcraft/tree/fix/first-owner-autofill/supabase) |
| Quality | [`tests`](https://github.com/Nischhalsubba/Formcraft/tree/fix/first-owner-autofill/tests) |
| Documentation | [`docs`](https://github.com/Nischhalsubba/Formcraft/tree/fix/first-owner-autofill/docs) |
| Delivery | [`.github`](https://github.com/Nischhalsubba/Formcraft/tree/fix/first-owner-autofill/.github), [`scripts`](https://github.com/Nischhalsubba/Formcraft/tree/fix/first-owner-autofill/scripts) |
...
Relevant detected files: [`assets/js/auth-onboarding.js`](https://github.com/Nischhalsubba/Formcraft/blob/fix/first-owner-autofill/assets/js/auth-onboarding.js).
...
- [`tests`](https://github.com/Nischhalsubba/Formcraft/tree/fix/first-owner-autofill/tests)
...
```mermaid
flowchart LR
    CHANGE["Change on fix/first-owner-autofill"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/ui-audit.yml`](https://github.com/Nischhalsubba/Formcraft/blob/fix/first-owner-autofill/.github/workflows/ui-audit.yml)
...
| Branch | [`fix/first-owner-autofill`](https://github.com/Nischhalsubba/Formcraft/tree/fix/first-owner-autofill) |
