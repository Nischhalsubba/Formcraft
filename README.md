...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/nepal-erp-suite`](https://github.com/Nischhalsubba/Formcraft/tree/agent/nepal-erp-suite). It is generated from the files present on this branch and preserves the project-authored README below.
...
| Detected stack | JavaScript, CSS, Python, HTML, TypeScript |
...
```mermaid
flowchart LR
    CHANGE["Change on agent/nepal-erp-suite"]
