...
(() => {
  ...
  renderDashboard = function renderTaskFirstDashboard() {
      ...
      <section class="product-dashboard-bottom">
        ...
        <article class="product-panel">
          ...
          <div class="command-grid">
            <button class="command-button" type="button" data-command="projects">${icon('projects', 20)}<strong>New project</strong><span>Define scope and ownership</span></button>
            <button class="command-button" type="button" data-command="tasks">${icon('tasks', 20)}<strong>New task</strong><span>Assign the next action</span></button>
            <button class="command-button" type="button" data-command="calendar">${icon('calendar', 20)}<strong>New event</strong><span>Schedule a review or deadline</span></button>
            <button class="command-button" type="button" data-command="invoices">${icon('invoices', 20)}<strong>New invoice</strong><span>Record billing and due dates</span></button>
          </div>
        </article>
      </section>
    </div>`;
  ...
  bindPage = function bindProductDashboard() {
    previousBindPage();
  ...
  document.documentElement.classList.add('formcraft-product-direction');
