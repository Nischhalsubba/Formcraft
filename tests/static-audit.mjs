...
assert.match(onboardingJs, /waitForElement: 600/);
assert.match(onboardingJs, /max-width: 820px/);
assert.match(onboardingJs, /\.fc4-sidebar \.fc4-workspace-brand/);
assert.match(onboardingJs, /\.fc4-sidebar \.fc4-stable-nav/);
assert.match(onboardingJs, /\.fc3-mobile-bottom-nav/);
